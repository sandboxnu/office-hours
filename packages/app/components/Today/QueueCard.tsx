...
const NotesInputDiv = styled(NotesDiv)`
  width: 100%;
  margin-top: 6px;
`;
...
const QueueCard = ({
  ...
  const ViewQueueLink = () => (
    ...
    >
      <OpenQueueButton style={{}} size="large" data-cy="open-queue-button">
        View Queue
      </OpenQueueButton>
    </Link>
  );
  ...
  return (
    <PaddedCard
      ...
      bodyStyle={{ paddingTop: isMobile && "15px" }}
